...
public class EvaluateDivision399 {
    ...
    public static void main(String[] args) {
        ...
        e.add(new ArrayList<>(Arrays.asList("a", "b")));
        e.add(new ArrayList<>(Arrays.asList("b", "c")));
        e.add(new ArrayList<>(Arrays.asList("bc", "cd")));
        ...
        System.out.println(Arrays.toString(calcEquation(e, values, queries)));
    }
}
