...
public class LinedListPalindrome {
    ...
    public static Boolean linkedListPalindrome(LinkedList head) {
        ...
        int second = 0;
        if (listLength % 2 == 0) {
            second = Math.abs(listLength / 2) + 1;
        } else {
            second = (int) Math.ceil(listLength / 2) + 2;
        }
        int count = 1;
        ...
        // Reverse a second part of ll
        LinkedList nextNode = secondPtr.next;
        ...
        traverse(secondPtr);
        while (secondPtr != null && firstPtr.value == secondPtr.value) {
            firstPtr = firstPtr.next;
            secondPtr = secondPtr.next;
        }

        if (secondPtr == null) return true;
        return false;
    }
...
//        LinkedList l10 = new LinkedList(5);
        ...
        LinkedList l7 = new LinkedList(2);
        LinkedList l8 = new LinkedList(1);
        LinkedList l9 = new LinkedList(0);
        l.next = l1;
        l1.next = l2;
        l2.next = l3;
        l3.next = l4;
